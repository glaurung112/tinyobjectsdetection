...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, required=True, help='Ruta al modelo .pt')
    parser.add_argument('--source', type=str, required=True, help='Archivo o carpeta de entrada')
    parser.add_argument('--img', type=int, nargs='+', required=True, help='Tamaño de la imagen de entrada (ej. 320 o 320 320)')
    parser.add_argument('--conf', type=float, required=True, help='Umbral de confianza mínima para las detecciones')
